...
const SOURCES = [
  ...
  {
    org: "Vercel AI Gateway → Anthropic",
    shortName: "Claude (anthropic/claude-sonnet-4-6)",
    url: "https://vercel.com/docs/ai-gateway",
    what: "Requests are routed through Vercel AI Gateway to Anthropic Claude models for the interpretation layer — plain-English conditions assessments, activity guidance, and local insights per location.",
    cost: "Gateway / model usage — not publicly billed to users",
    updateFrequency: "AI summaries cached for 15 minutes per location",
    license: "Vercel and Anthropic provider terms",
  },
  {
