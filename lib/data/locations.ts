...
export const PEI_LOCATIONS: Location[] = [
  ...
  },
  {
    id: "pondside-park",
    name: "Pondside Park",
    nameFr: "Parc Pondside",
    tagline: "Stratford's quiet 1 km nature trail through varied terrain along a stream — a peaceful escape minutes from Charlottetown.",
    lat: 46.218,
    lng: -63.082,
    type: "park",
    nearestStation: PEI_STATIONS.charlottetown,
    ...
    amenities: {
      parking: "free",
      parkingNote: "Free street parking along Keppoch Road near the park entrance",
      petFriendly: true,
      petNote: "Dogs welcome on leash along the natural trail",
      wheelchairAccessible: false,
      wheelchairNote: "Natural trail surface — not suitable for wheelchairs or strollers",
      washrooms: false,
      washroomNote: "No on-site washrooms — nearest facilities at Tea Hill Provincial Park",
    },
  },
  {
    id: "tea-hill",
  ...
  },
  {
    ...
    name: "Kensington",
    nameFr: "Kensington",
    tagline: "PEI's fastest-growing town — rolling farmland, the Confederation Trail trailhead, and a tight-knit community between Summerside and Charlottetown.",
    lat: 46.4432,
    lng: -63.6403,
    type: "community",
    nearestStation: PEI_STATIONS.summerside,
    ...
    amenities: {
      parking: "free",
      parkingNote: "Free parking throughout downtown Kensington and at the Confederation Trail trailhead",
      petFriendly: true,
      petNote: "Dogs welcome on leash along the Confederation Trail and in town parks",
      wheelchairAccessible: true,
      wheelchairNote: "The Confederation Trail's crushed-gravel surface is firm and flat — accessible for most mobility aids",
      washrooms: true,
      washroomNote: "Seasonal portable washrooms at the Confederation Trail trailhead; indoor facilities at the Credit Union Centre (EVK Memorial Pool)",
    },
  },
  {
    id: "kinlock-beach",
  ...
  },
  {
    ...
    name: "St. Stephen",
    nameFr: "St. Stephen",
    tagline: "Charlotte County's gateway town on the St. Croix River — the chocolate capital of Canada, right on the New Brunswick–Maine border.",
    lat: 45.1972,
    lng: -67.2789,
    type: "community",
    nearestStation: "8101200",
    activities: ["walking", "cycling", "dining"],
    icon: "🍫",
    amenities: {
      parking: "free",
      parkingNote: "Free parking throughout downtown St. Stephen and along the waterfront",
      petFriendly: true,
      petNote: "Dogs welcome on leash along the St. Croix waterfront trail",
      wheelchairAccessible: true,
      wheelchairNote: "Accessible downtown sidewalks and waterfront boardwalk",
      washrooms: true,
      washroomNote: "Public washrooms at the Visitor Information Centre on King Street — open seasonally",
    },
  },
  {
