...
export const PEI_LOCATIONS: Location[] = [
  ...
  },
  {
    ...
    name: "Summerside",
    nameFr: "Summerside",
    tagline: "PEI's second city — a relaxed waterfront with the best sunsets on the island and easy access to the western trail.",
    lat: 46.3942,
    lng: -63.7892,
    type: "city",
    nearestStation: PEI_STATIONS.summerside,
    ...
    amenities: {
      parking: "free",
      parkingNote: "Free parking throughout downtown Summerside and along the waterfront boardwalk",
      petFriendly: true,
      petNote: "Dogs welcome on leash along the Rotary Friendship Park boardwalk",
      wheelchairAccessible: true,
      wheelchairNote: "Accessible boardwalk and downtown sidewalks — some heritage blocks have uneven surfaces",
      washrooms: true,
      washroomNote: "Public washrooms at Rotary Friendship Park and Spinnakers Landing, open seasonally",
    },
  },
  {
    id: "stratford",
  ...
  },
  {
    ...
    name: "Cornwall",
    nameFr: "Cornwall",
    tagline: "Charlottetown's west-shore neighbour — West River boardwalks, Terry Fox Sports Complex, and the gateway to the south shore.",
    lat: 46.2370,
    lng: -63.2150,
    type: "community",
    nearestStation: PEI_STATIONS.charlottetown,
    ...
    amenities: {
      parking: "free",
      parkingNote: "Free parking at the Terry Fox Sports Complex, Cornwall Boardwalk, and APM Centre",
      petFriendly: true,
      petNote: "Dogs welcome on leash along the West River boardwalk and the Cornwall Trail",
      wheelchairAccessible: true,
      wheelchairNote: "Paved boardwalk and accessible paths through the Terry Fox Sports Complex",
      washrooms: true,
      washroomNote: "Seasonal washrooms at the Cornwall Boardwalk and year-round at the APM Centre during operating hours",
    },
  },
  {
